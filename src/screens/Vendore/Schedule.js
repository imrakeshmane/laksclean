...
const Schedule = ({ route, navigation }) => {
    ...
    const purchaseCard = ({ item, index }) => {
        return (
            ...
            <View style={{ flexDirection: 'column', backgroundColor: '#fff', margin: 10, padding: 10, elevation: 4, borderRadius: 10 }}>
                <Text style={{ color: 'red', fontSize: 16, fontWeight: 'bold', justifyContent: 'flex-end', textAlign: 'right', padding: 10 }}>Pending </Text>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Text style={{ color: '#000000', fontSize: 16, fontWeight: 'bold' }}>Package -: </Text>
                    <Text style={{ color: '#000000', fontSize: 16, fontWeight: 'bold' }}>{item.Package}</Text>
                </View>

                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', margin: 10 }}>
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        <Text style={{ backgroundColor: 'green', color: '#fff', fontSize: 20, borderRadius: 5, padding: 10, justifyContent: 'center', textAlign: 'center', margin: 10 }}>Accept </Text>
                    </TouchableOpacity>
                    <Text style={{ backgroundColor: 'red', color: '#fff', fontSize: 20, borderRadius: 5, padding: 10, justifyContent: 'center', textAlign: 'center', margin: 10 }}>Reject</Text>
                </View>
